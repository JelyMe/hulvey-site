...
$.get('config.txt',{},function(content){
    ...
    if ((links[3] != null && links[3] != "") && !/Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent)) game.href = links[3]; else {game.parentElement.style.opacity = 0.4; game.parentElement.style.pointerEvents = "none"; if(/Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent)) game.parentElement.style.display = "none";}
    if (links[2] != null && links[2] != "") tour.href = links[2]; else {tour.parentElement.style.opacity = 0.4; tour.parentElement.style.pointerEvents = "none";}
});
